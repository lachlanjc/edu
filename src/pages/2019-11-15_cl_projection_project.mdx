...
## Try the app (Apple Pencil required)

<Glitch src="https://glitch.com/embed/#!/embed/cl-drawing?path=shoe/index.html&previewSize=100" />

<Glitch src="https://glitch.com/embed/#!/embed/cl-drawing?path=box/index.html&previewSize=100" />
...
We decided to have two separate iPads, one for drawing on the shoe & one for the box. With the drawing functionality itself fully built, I made two variants, one for each device. Irene made a set of four drawings of the shoe, so I added jQuery-powered buttons at the top of the screen of the Shoe app. On the Box app, I made the background black & added the box design on top of drawing layer.
