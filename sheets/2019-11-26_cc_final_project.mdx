...
<Button
  ...
  sx={{ bg: '#ec3750' }}
  children="Open Gun Funded"
/>

[GitHub](https://github.com/lachlanjc/gunfunded)
[Glitch](https://glitch.com/~gunfunded)

Watch my demo: (37:00)

<YouTube id="11M3RLmayz8" params="start=2222" />

![Muse board](https://d2wkqk610zk1ag.cloudfront.net/items/0o0R2e2i3p03291q0S0B/twhejwqzzgf75xqxteufnpxubwj37m2u.png)

## From the show

<Box sx={{ display: 'grid', gridTemplateColumns: [null, 'repeat(2, 1fr)'], gap: [3, 4] }}>
