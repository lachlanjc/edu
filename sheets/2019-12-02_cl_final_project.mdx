...
Today we put the machine together for an in-class demo. Things _mostly_ worked, but we got a bunch of great feedback from Gabe & the class to integrate into the final version.
